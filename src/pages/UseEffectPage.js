...
const UseEffectPage = () => {
    ...
    return (
        <div>
            <h2>Definition:</h2>
            <blockquote><code>useEffect(callback, dependencies)</code> is the hook that manages the side-effects in functional components. <code>callback</code> argument is a function to put the side-effect logic. <code>dependencies</code> is a list of dependencies of your side-effect: being props or state values.</blockquote>
            <blockquote>If you’re familiar with React class lifecycle methods, you can think of <code>useEffect</code> Hook as <code>componentDidMount</code>, <code>componentDidUpdate</code>, and <code>componentWillUnmount</code> combined.</blockquote>
